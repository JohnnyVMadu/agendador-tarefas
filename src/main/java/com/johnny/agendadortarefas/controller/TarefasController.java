package com.johnny.agendadortarefas.controller;

import com.johnny.agendadortarefas.business.TarefasService;
...
public class TarefasController {
    ...
    @PatchMapping
    public ResponseEntity<TarefasDTO> alteraStatusNoyificacao(@RequestParam("status") StatusNotificacaoEnum status,
